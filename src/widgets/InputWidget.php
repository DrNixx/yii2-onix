...
/**
 * InputWidget is the base class for widgets extending the [[YiiInputWidget]]
 *
 ...
 * ```
 */
class InputWidget extends YiiInputWidget implements IInputWidget
{
    ...
    protected function getLoadProgress()
    {
        return "<div class=\"progress-circle-indeterminate text-hide\">".Yii::t("common", "Loading...")."</div>";
    }
