...
/**
 * WidgetTrait manages all methods used by widgets and input widgets.
 *
...
trait WidgetTrait
{
     ...
     *
     * - 'data-onix-{name}' will store the hashed variable storing the plugin options. The `{name}` token will be
    ...
    protected function hashPluginOptions($name)
    {
        ...
        $this->options['data-onix-' . $name] = $this->_hashVar;
    }
    /**
